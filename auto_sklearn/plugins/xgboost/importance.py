...
from auto_sklearn.selection.importance import ImportanceExtractor
...
class XGBImportancePlugin(ModelPlugin):
    ...
    def post_fit(
        ...
        if not hasattr(model, "_auto_sklearn_meta"):
            model._auto_sklearn_meta = {}

        model._auto_sklearn_meta["feature_importance"] = importance
        model._auto_sklearn_meta["importance_type"] = self.importance_type
    ...
    def get_importance(
        ...
        if hasattr(model, "_auto_sklearn_meta"):
            cached = model._auto_sklearn_meta.get("feature_importance")
