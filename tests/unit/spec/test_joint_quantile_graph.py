"""Tests for JointQuantileGraphSpec and related classes."""
...
class TestJointQuantileGraphSpecOrdering:
...
class TestJointQuantileGraphSpecValidSwaps:
    """Tests for get_valid_swaps method."""
